...
# ...........DATASET LOADING..........
# Dataset 1
df1 = pd.read_csv("../datasets/raw/Crop_recommendation.csv")

# Dataset 2
df2 = pd.read_csv("../datasets/raw/crop_yield.csv")

# Dataset 3
df3 = pd.read_csv("../datasets/raw/state_soil_data.csv")

# Dataset 4
df4 = pd.read_csv("../datasets/raw/state_weather_data_1997_2020.csv")
...
merged_df.to_csv(
    "../datasets/processed/cleaned_crop_yield_dataset.csv",
    index=False
)
